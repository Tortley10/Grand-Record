...
document.addEventListener('DOMContentLoaded', () => {
    ...
    logo.addEventListener('mouseover', () => {
        wings.forEach(wing => {
            ...
            wing.style.boxShadow = '0 0 20px #007808';
        ...
        letter.style.textShadow = '0 0 20px #007808, 0 0 30px #007808, 0 0 40px #007808';
    });
    ...
    logo.addEventListener('mouseout', () => {
        ...
        letter.style.textShadow = '0 0 10px #007808, 0 0 20px #007808';
    });
});